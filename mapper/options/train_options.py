...
class TrainOptions:
	...
	def initialize(self):
		self.parser.add_argument('--exp_dir', default='./results/cutomized_17th_wizauintensity_only_au_loss',type=str, help='Path to experiment output directory')
		...
		self.parser.add_argument('--checkpoint_path', default="./results/cutomized_12th_with_auloss_simple_clip/checkpoints/iteration_50000.pt", type=str, help='Path to StyleCLIPModel model checkpoint')
